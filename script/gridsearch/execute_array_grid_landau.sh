...
python src/simulate.py -p 100 --landau --out_dir /data/ci1wow/simulations/gridsearch/landau/$SGE_TASK_ID

    #python src/gridsearch/simulate.py -p 100 --floryhuggins --out_dir /fastdata/simulations/gridsearch/floryhuggins/$RUN_DIR
